...
namespace Jun.Data.Repository
{
    public class RepositoryBase : IRepositoryBase
    {

        private readonly JunDbContext _dbContext;
        ...
        public int Delete<TEntity>(int id) where TEntity : class, new()
        {
            ...
            ReflectionUtil.SetPropertyValue(entity, EntityConst.EntityIdName, id);
        ...
        {
            bool isAsc = pagination.SortOrder.ToLower() == "asc" ? true : false;
            string orderField = pagination.SortField;
        ...
        {
            var user = _webHelper.GetUser();
            if (user != null)
            {
                int id = (int)ReflectionUtil.GetPropertyValue(user, EntityConst.EntityIdName);
                ReflectionUtil.SetPropertyValue(objs, "createuserid", id);
                ReflectionUtil.SetPropertyValue(objs, "updateuserid", id);
            }
